...
export const METHODS: Topic[] = [
  {
    ...
    equations: [
      ...
      { tex: r`\begin{gathered} R_{bank} = \int_0^\infty R_{batch}(t)\,\frac{t^{N-1}e^{-t/\tau_c}}{\tau_c^N (N-1)!}\,dt \\ R^{FO}_{bank} = A\left[1 - (1 + k\tau_c)^{-N}\right] \end{gathered}`, caption: { en: 'Projection to a bank of N cells of residence tau_c, and its first-order closed form.', es: 'Proyección a un banco de N celdas de residencia tau_c, y su forma cerrada de primer orden.' } },
    ],
    limits: [
