...
export const STREAMS: Topic[] = [
  {
    ...
    equations: [
      ...
      { tex: r`L_i = \frac{1}{1 + (d_i/x_L)^{n_L}},\qquad \rho_c = \frac{1}{c/\rho_V + (1-c)/\rho_{host}}`,
        caption: { en: 'Liberated fraction with liberation size x_L and slope n_L, and the density of a composite of valuable content c.', es: 'Fracción liberada con tamaño de liberación x_L y pendiente n_L, y la densidad de un mixto de contenido valioso c.' } },
